...
public class Lab148_StringBuilder_StringBuffer {
    public static void main(String[] args) {
        //        String name = "Pramod";
//        name = "Aramod";

        // final class StringBuffer
        StringBuffer stringBuffer = new StringBuffer("Anita");
        StringBuffer stringBuffer1 = new StringBuffer("Kosuri");
        stringBuffer.append("Kosuri");
        stringBuffer1.append("Anita");
